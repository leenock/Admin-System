            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title">New User Profile -
                ...
                {!! Form::open(array('route' => 'users.store','method'=>'POST')) !!}
                  ...
                  <div class="form-group bmd-form-group">
                      <label for="text" class="bmd-label-floating"> Full Names *</label>
                      <input type="text" class="form-control" id="text" name="name" required="true" aria-required="true">
                    </div>

                    <div class="form-group bmd-form-group">
                      <label for="exampleEmail" class="bmd-label-floating"> Email Address *</label>
                      <input type="email" class="form-control" id="exampleEmail" name="email" required="true" aria-required="true">
                    </div>
                    <div class="form-group bmd-form-group">
